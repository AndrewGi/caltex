...
impl FromStr for BasicNumber {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.parse::<i64>() {
            ...
            Err(_) => Ok(BasicNumber::Float(s.parse::<f64>()?)),
        }
    }
}
impl core::ops::Add for BasicNumber {
...
impl core::ops::Sub for BasicNumber {
    type Output = BasicNumber;
...
impl core::ops::Mul for BasicNumber {
    type Output = BasicNumber;
...
impl core::ops::Neg for BasicNumber {
    type Output = BasicNumber;
